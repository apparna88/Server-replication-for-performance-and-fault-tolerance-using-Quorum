...
########################################################
#   GENERAL OPERATIONS CHANGING PERMISSIONS
#   for various subdir/dir depth
########################################################
general_operations(){
echo "****TESTING GENERAL OPERTIONS****"
echo "***Before Changing Mode***">gen_op.txt 
ls -l ./fusemount/ > gen_op.txt
...
ls -R ./fusemount/ >> remove_test_dir0.txt
rm -r ./fusemount/dir0   #to delete files with sub directories
ls -R ./fusemount/ >> remove_test_dir0.txt
}
